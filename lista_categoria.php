...
<body>
    ...
    <div class="container">
        <h3 style="margin-top: 40px; margin-bottom: 20px;"> Lista de Categorias </h3>
        ...
        <div style="text-align: right">
            ...
            <a style="  background-color: #FF1168; color: #ffffff; font-family: sans-serif;" href="adicionar_categoria.php" role="button" class="btn btn-sm"> Adcionar</a>
